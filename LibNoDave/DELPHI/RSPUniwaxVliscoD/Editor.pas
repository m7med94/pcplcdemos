...
begin
  ...
  begin
    ...
    Protocol.ItemIndex:=IniFile.ReadInteger(Name, 'Protocol', 0);
...
begin
  COMPort.Enabled:=(Protocol.ItemIndex in [1]);
  IPAddress.Enabled:=(Protocol.ItemIndex in [0]);
  Timeout.Enabled:=(Protocol.ItemIndex in [0]);
  MPISpeed.Enabled:=(Protocol.ItemIndex in [1]);
  MPILocal.Enabled:=(Protocol.ItemIndex in [1]);
  MPIRemote.Enabled:=(Protocol.ItemIndex in [1]);
end;
