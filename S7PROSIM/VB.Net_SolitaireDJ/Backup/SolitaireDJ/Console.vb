        ...
        Else
            If ConnectionSim Then
                ...
                If IsBitSet(pDataCons(0), 4) Then
                    PS_DJ1_TC12PrehCompl.BackColor = Color.Yellow
                Else
                    PS_DJ1_TC12PrehCompl.BackColor = Color.Brown
                End If
                ...
                If IsBitSet(pDataCons(0), 6) Then
                    PFM1_complete.BackColor = Color.Yellow
                Else
                    PFM1_complete.BackColor = Color.Brown
                End If
                If IsBitSet(pDataCons(0), 7) Then
                    PFM2_complete.BackColor = Color.Yellow
                Else
                    PFM2_complete.BackColor = Color.Brown
                End If

                ''*************************************************
                If IsBitSet(pDataCons(1), 0) Then
                    PS_SP_ReqPipe.BackColor = Color.Yellow
                Else
                    PS_SP_ReqPipe.BackColor = Color.Brown
                End If
                ...
                If IsBitSet(pDataCons(1), 5) Then
                    PS_SP_LineUpCmpl.BackColor = Color.Yellow
                Else
                    PS_SP_LineUpCmpl.BackColor = Color.DarkOrange
                End If
                If IsBitSet(pDataCons(1), 6) Then
                    PS_SP_W1Cmpl.BackColor = Color.Yellow
                Else
                    PS_SP_W1Cmpl.BackColor = Color.DarkOrange
                End If
                ...
                If IsBitSet(pDataCons(2), 3) Then
                    SB_DJ1_TC12RotComplete.BackColor = Color.Yellow
                Else
                    SB_DJ1_TC12RotComplete.BackColor = Color.DarkOrange
                End If

                If IsBitSet(pDataCons(2), 4) Then
                    SB_JD1_TC12PrehCompl.BackColor = Color.Yellow
                Else
                    SB_JD1_TC12PrehCompl.BackColor = Color.DarkOrange
                End If
                ...
                If IsBitSet(pDataCons(2), 6) Then
                    SB_SP_ReqPipe.BackColor = Color.Yellow
                Else
                    SB_SP_ReqPipe.BackColor = Color.DarkOrange
                End If
                ...
                If IsBitSet(pDataCons(3), 0) Then
                    PS_DJ2_TC58Home.BackColor = Color.Yellow
                Else
                    PS_DJ2_TC58Home.BackColor = Color.DarkOrange
                End If
                ...
                If IsBitSet(pDataCons(4), 0) Then
                    SB_DJ2_TC58Home.BackColor = Color.Yellow
                Else
                    SB_DJ2_TC58Home.BackColor = Color.DarkOrange
                End If
                ...
                If IsBitSet(pDataCons(5), 3) Then
                    PS_DJ1_TC34PrehCompl.BackColor = Color.Yellow
                Else
                    PS_DJ1_TC34PrehCompl.BackColor = Color.Brown
                End If
