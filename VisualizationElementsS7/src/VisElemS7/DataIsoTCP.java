...
import VisElemS7.driver.TCPConnection;
...
public class DataIsoTCP {
	...
	public static Socket sock;
        ...
        //read 4 bytes from merk 100,101,102,103
        public static long ReadData() {
            dc.readBytes(Nodave.FLAGS, 0, 100, 4, null);
            a = dc.getU32();
            return (long)a;
        }
        public static long ReadData1() {
            dc.readBytes(Nodave.FLAGS, 0, 104, 4, null);
            a = dc.getU32();
            return (long)a;
        }
         public static long ReadData2() {
            dc.readBytes(Nodave.FLAGS, 0, 109, 1, null);
            a = dc.getBYTE();
            return (short)a;
        }
       //write 4 bytes to merk 100,101,102,103
        public static void WriteData(long a) {
            by = Nodave.bswap_32(a + 1);
            dc.writeBytes(Nodave.FLAGS, 0, 100, 4, by);
        }
        public static void WriteData1(long a) {
            by = Nodave.bswap_32(a + 1);
            dc.writeBytes(Nodave.FLAGS, 0, 104, 4, by);
        }
        //write 4 bytes to merk 109
        public static void WriteData2(short a) {
            by = Nodave.bswap_8(a + 1);
            dc.writeBytes(Nodave.FLAGS, 0, 109, 1, by);
        }
