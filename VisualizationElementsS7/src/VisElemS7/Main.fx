...
import VisElemS7.view.ImageButton;
import VisElemS7.Simulation;
import VisElemS7.model.Parameters;
import VisElemS7.model.InitParameters;

import VisElemS7.element.TankA;
import VisElemS7.element.TankC;
import VisElemS7.element.TankZ;
import VisElemS7.element.ControlValve;
import VisElemS7.element.Flowmeter;
import VisElemS7.element.Agitator;
import VisElemS7.element.ElectricValve;
import VisElemS7.element.Pump;
import VisElemS7.element.Alarm;
...
function run()  {
    ...
    //DataIsoTCP243.Start('130.143.128.11');
    simulation.start();
    tankC.start();
    pump.start();
    conveyor.start();
