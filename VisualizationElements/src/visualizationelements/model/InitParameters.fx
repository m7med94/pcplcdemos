 ...
 */
package visualizationelements.model;
/**
 * @author Alex Sentcha
 */
import visualizationelements.Main;
...
public function addParameters(){
    ...
    result.comment = "try to change: scale, on-off, value";
    ...
    result.comment = "try to change: scale, on-off, rotation value";
    insert result into Main.parameters;
